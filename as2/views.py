...
def home(request, *kw, **kwargs):
    ...
    return render(request, 'as2/about.html', {'pyas2info': pyas2init.gsettings})
...
class MessageSearch(View):
    ...
    template_name = 'as2/message_search.html'
...
class PayloadView(View):
    ...
    template_name = 'as2/file_view.html'
...
class MDNSearch(View):
    ...
    template_name = 'as2/mdn_search.html'
...
class SendMessage(View):
    ...
    template_name = 'as2/sendmessage.html'
        ...
        try:
            ...
            if mdn_message:
                ...
                try:
                    ...
                    message = get_object_or_404(models.Message, message_id=msg_id.strip('<>'), organization=org,
                                                partner=partner)
